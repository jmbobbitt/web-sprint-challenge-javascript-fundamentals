...
//    It reaches outside using closure.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(anArray){
    let newArray = anArray.map(function(item, i) {
    return anArray[i].animal_name.toLowerCase()});
    return newArray;
  }
  ...
  */
  ...
  function lowPopulationAnimals(anArray){
    let newArray = anArray.filter(function(item, i)
    {
      return anArray[i].population < 5
    });
    return newArray;
  }
